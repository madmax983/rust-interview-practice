...
// Guards are intentionally held across the sleep/print to demonstrate reader-writer
// lock semantics for gittype practice; tightening the drop would defeat the demo.
